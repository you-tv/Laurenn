...
const aes256Badge = "https://placehold.co/200x200?text=AES-256";
...
import dataCenterImage from "figma:asset/webinar_mockup.jpg";
const ovhcloudLogo = "https://placehold.co/200x80?text=OVHcloud";
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                ...
                >
                  <Card className="p-6 h-full hover:shadow-xl transition-all text-center">
                    <img src={ensLogo} alt="ENS" className="h-20 w-20 mx-auto mb-4 object-contain" />
                    <h4 className="text-xl font-bold text-gray-900 mb-2">ENS (Espagne)</h4>
                    <p className="text-sm text-gray-600">
                      Esquema Nacional de Seguridad : protection des systèmes d'information.
                    </p>
                  </Card>
                </motion.div>
                ...
                >
                  <Card className="p-6 h-full hover:shadow-xl transition-all text-center">
                    <img src={hipaaLogo} alt="HIPAA" className="h-20 w-20 mx-auto mb-4 object-contain" />
                    <h4 className="text-xl font-bold text-gray-900 mb-2">HIPAA (USA)</h4>
                    <p className="text-sm text-gray-600">
                      Standard américain pour la sécurité des données de santé.
                    </p>
                  </Card>
                </motion.div>
                ...
                >
                  <Card className="p-6 h-full hover:shadow-xl transition-all text-center">
                    <img src={hdsLogo} alt="HDS" className="h-20 w-20 mx-auto mb-4 object-contain" />
                    <h4 className="text-xl font-bold text-gray-900 mb-2">HDS (France)</h4>
                    <p className="text-sm text-gray-600">
                      Hébergeur de Données de Santé : certification française souveraine.
                    </p>
                  </Card>
                </motion.div>
                ...
                >
                  <Card className="p-6 h-full hover:shadow-xl transition-all text-center">
                    <img src={acnLogo} alt="ACN" className="h-20 w-20 mx-auto mb-4 object-contain" />
                    <h4 className="text-xl font-bold text-gray-900 mb-2">ACN (Italie)</h4>
                    <p className="text-sm text-gray-600">
                      Agenzia per la Cybersicurezza Nazionale : souveraineté italienne.
                    </p>
                  </Card>
                </motion.div>
              </div>
