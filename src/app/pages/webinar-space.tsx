...
export default function WebinarSpace() {
  ...
  const pastWebinars: Webinar[] = [
    ...
    },
    {
      ...
      time: '17:00',
      duration: '1 heure',
      thumbnail: 'https://images.unsplash.com/photo-1560439514-4e9645039924?w=400&h=200&fit=crop',
      status: 'recording-ready',
      registrants: 220,
      participants: 178
    },
  ...
  const upcomingWebinars: Webinar[] = [
    {
      ...
      time: '17:30 - 23:15',
      duration: '04:30',
      thumbnail: 'https://images.unsplash.com/photo-1551818255-e6e10975bc17?w=400&h=200&fit=crop',
      status: 'upcoming',
      registrants: 250,
      participants: 0
    }
