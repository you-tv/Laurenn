...
export const ContainerScroll = ({
  ...
  const scaleDimensions = () => {
    // 0.6 scale on load (40% smaller), 1.1 scale on scroll
    return isMobile ? [0.7, 1] : [0.6, 1.1];
  };
  ...
  return (
    <div
      className="h-auto w-full flex items-start justify-center relative p-2 md:p-10 pb-20 md:pb-32"
      ref={containerRef}
    >
      <div
        className="pt-10 md:pt-16 w-full relative"
        style={{
          perspective: "1000px",
        }}
      >
