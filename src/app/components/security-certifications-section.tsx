...
const cards: CardData[] = [
  ...
  {
    id: "card-bsi-c5",
    logo: anssiLogo, // Using anssi as placeholder for BSI C5 per previous setup
    title: "BSI C5",
...
export function SecurityCertificationsSection() {
  return (
    <section className="py-24 lg:py-32 bg-gray-50 font-['Nunito',sans-serif]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-3 bg-purple-100/50 text-[#5e2d91] px-6 py-2 rounded-full mb-6 border border-purple-200">
            ...
            <span className="font-bold text-xs tracking-widest uppercase font-sans">Sécurité & Souveraineté</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-[16px] max-w-6xl mx-auto">
          {/* Row 1 - 4-5-3 span */}
          <div className="md:col-span-4">
            <ComplianceCard card={cards[0]} />
          </div>
          <div className="md:col-span-5">
            <ComplianceCard card={cards[1]} />
          </div>
          <div className="md:col-span-3">
            <ComplianceCard card={cards[2]} />
          </div>

          {/* Row 2 - 5-3-4 span */}
          <div className="md:col-span-5">
            <ComplianceCard card={cards[3]} />
          </div>
          <div className="md:col-span-3">
            <ComplianceCard card={cards[4]} />
          </div>
          <div className="md:col-span-4">
            <ComplianceCard card={cards[5]} />
          </div>
        </div>
...
function ComplianceCard({ card }: { card: CardData }) {
  return (
    <div className="bg-white rounded-[20px] p-[36px_36px_30px] h-full flex flex-col relative overflow-hidden shadow-[0_2px_12px_rgba(80,70,160,0.06)] group transition-transform hover:-translate-y-1 duration-300">
      ...
      <div className="z-10 relative flex-1 flex flex-col">
        ...
        {/* Title */}
        <h3 className="font-[800] text-[#1a1a2e] mb-[12px] text-[20px]">
          {card.title}
        </h3>
